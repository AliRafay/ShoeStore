...
function About() {
    return (
      <div className="About">
         ...
         <div className="AboutSasta"><h1>"Rafay SHOE STORE"</h1>
         </div>
          ...
          <p><b>Our mission is to inspire individuals to live life on the bright side.
             We believe optimism is contagious, and through small acts of positivity,
              we can help shape a brighter world.
               ...
               <p><b>Rafay Shoe Store was founded in 2000,
                  ...
                  we created shoes to help them hush their puppies. We’ve stood for comfort from the beginning,
                   ...
                   <p><b>In the '50s and '60s, black and brown were the only color options for footwear.
                      ...
                      <p><b>Rafay Shoe Store is part of the fashion history of Pakistan. Our shoes have been worn by celebrities and icons ranging from rock stars to royalty.
                         It’s been reported that Rafay shoe store may have saved the life of Rolling Stones guitarist Keith Richards when he accidentally touched his guitar against an ungrounded microphone at a 2010 concert – so basically,
